...
const PaginaBuscarRestaurante = () => {
  ...
  const filtrandoRestaurantes = restaurantes
    .filter((restaurante) => {
      if (buscaRestaurante == "") {
        return restaurante;
      } else if (
        restaurante.name.toLowerCase().includes(buscaRestaurante.toLowerCase())
      ) {
        return restaurante;
      }
    })
  ...
  return (
    <div>
      ...
      <Flex direction="column" align="center" width="100vw" padding="16px">
        <Input
          size="md"
          type="text"
